...
export default function InvitePage() {
  ...
  const fullCode = code ? `FEELY-${code}` : ''
  ...
  return (
    <div style={{
      ...
      <p style={{ color: 'rgba(255,255,255,0.5)', textAlign: 'center', maxWidth: 340, lineHeight: 1.5, fontSize: 15, marginBottom: 40 }}>
        Jemand moechte, dass du FEELY ausprobierst — die App die dir zeigt, wie gesund deine Lebensmittel wirklich sind.
      </p>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.3)', marginTop: 12, lineHeight: 1.4 }}>
          Der Code wurde automatisch kopiert. Gib ihn bei der Registrierung ein.
        </p>
      </div>
      ...
      {/* Trust */}
      <div style={{ marginTop: 48, width: '100%', maxWidth: 360, display: 'flex', flexDirection: 'column', gap: 12 }}>
        {[
          ...
          { icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z', text: 'Verstehe was du isst — lebe gesuender' },
        ].map((item, i) => (
